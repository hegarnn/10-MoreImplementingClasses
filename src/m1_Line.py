...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        line = Line(self.start.plus(other_line.start),self.end.plus(other_line.end))
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        line = Line(self.start.minus(other_line.start), self.end.minus(other_line.end))
    ...
    def midpoint(self):
        ...
        line = self.start.halfway_to(self.end)
        return line
